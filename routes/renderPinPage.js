...
function output_user_boards(res, req, login,results) {
	...
	res.render('pinit.jade',
		   { title: "Boards of User with login: " + login,
		     boardresults: results, objectID:req.query.pinobjectID, sourceID: req.query.pinsourceID, url: req.query.url,
		     user: login}
	  );
}
...
exports.do_work = function(req, res){
	...
	console.log("Current User:" + login + req.query.pinobjectID + req.query.pinsourceID);
	if(login){
